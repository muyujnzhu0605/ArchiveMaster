; 自定义常量
!define MainWindow "ArchiveMaster.UI.Desktop"
!define /date PRODUCT_TIME %Y%m%d%H%M
!ifdef ClientVersion
!else
  !define ClientVersion 1.0.0
!endif

; 安装程序初始定义常量
!define PRODUCT_NAME "文件归档大师"
!define PRODUCT_VERSION ${ClientVersion}
!define PRODUCT_PUBLISHER "autodotua"
!define PRODUCT_WEB_SITE "https://github.com/autodotua/ArchiveMaster"
...
!define MUI_ICON "..\..\ArchiveMaster.UI\Assets\icon_light.ico"
